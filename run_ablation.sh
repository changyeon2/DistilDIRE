...
CKPT="/workspace/DistilDIRE/experiments/truemedia-distil-dire-imagenet-lr1e-4wo_kd/ckpt/model_epoch_10.pth"
# python3 -m test --test True --datasets distil-test-adm-imagenet --pretrained_weights $CKPT
# python3 -m test --test True --datasets distil-test-sdv1-imagenet --pretrained_weights $CKPT
...
CKPT="/workspace/DistilDIRE/experiments/truemedia-distil-dire-celebahq-lr1e-4wo_kd/ckpt/model_epoch_11.pth"
python3 -m test --test True --datasets distil-test-adm-imagenet --pretrained_weights $CKPT
python3 -m test --test True --datasets distil-test-sdv1-imagenet --pretrained_weights $CKPT
